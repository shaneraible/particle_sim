...
LIBS = -lm
NVCC = nvcc
NVCCFLAGS =  -G -g -arch=compute_35 -code=sm_35 -gencode arch=compute_35,code=[compute_35,sm_35] -gencode arch=compute_61,code=[compute_61,sm_61]


TARGETS = serial openmp autograder gpu
